...
#include "type_wappers/Block_wapper.h"
#include "type_wappers/Dimension_wapper.h"
#include "type_wappers/ItemStack_wapper.h"
#include "type_wappers/Item_wapper.h"
#include "type_wappers/Level_wapper.h"
...
void setupTypeBinds(VM* vm) {
    ...
    type_wappers::BlockWapper::register_class(vm, typeWappersModule);
    type_wappers::LevelWapper::register_class(vm, typeWappersModule);
    type_wappers::DimensionWapper::register_class(vm, typeWappersModule);
